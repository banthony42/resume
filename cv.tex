  ...
  \begin{cvExperience}
    \cvItem{
      ...
      \en{Within Network Intrusion Detection System development team, for Telecom signaling traffic. I had the opportunity to develop, maintain and test all the staks of the software, or to resolve technical debt. Here is an non-exhaustive overview of the tasks i have made:
        ...
        Rework and improvement of the configurable API REST client\\
        (Lua/Coroutines/Redis)\\
        Improvement of the packet history system (C/Lua)\\
        Rewrite and improvement of the Elasticsearch cluster manager\\
        (Mappings, Templates, Lifecycles, bash -> python)\\
        ...
        Devops on a Jenkins CI composed of a master node and five slave nodes.
      ...
      \fr{Au sein de l'équipe de développement d'un IDS pour les réseaux Telecom, sur le traffic de signalisation. J'ai eu l'occasion de développer, maintenir et tester toute les couches du logiciel, ou encore résoudre de la dettes technique. Voici un apercu non exaustif de ce sur quoi j'ai pu travailler:
        \paragraph{\textnormal{\textit{Backend}}}: C, Lua, Python, Django, Bash\\
        Rework et amélioration d'un client API REST configurable (Lua/Coroutines/Redis)\\
        ...
        Outil de migration automatique de la base de donnée, en production, suite à la mise à jour d'Elasticsearch (5.6 -> 7.10). Résolutions des changements de format de données, sans pertes (10 à 40 millions de documents).\\
    ...
    \cvItem{
      ...
      \fr{Développement de nouvelles fonctionnalitées avec une attention particulière pour fournir une interface de qualité pour les utilisateurs du SDK.\\Maintenance et debug du code existant.\\Revue de code et méthode agile.}
    ...
    \cvItem{
      \en{Embedded development and mechanic, electronic conception}
