...
\begin{cvMainContent}
  \begin{cvExperience}
    \cvItem{
      ...
      \en{\enum {
          \item Development of a network IDS in Telecom environment.
          \item Real time traffic processing. (C / Lua)
          \item System tools (Python / Bash) and Web UI. (Python - Django)
          \item Jenkins devops tasks (one master node and five agents) VMs maintenance - test pipeline updates - unit tests - functional tests - end-to-end tests.
          \item Traceability tool, proof of concept for customer support. (Rust - actix - sqlx - serde - tokio - askama - Terraform - Docker)
        }
      }
      \fr{\enum{
          \item Développement d'un IDS réseaux, dans un environnement Telecom.
          \item Traitement du traffic en temps réel. (C / Lua)
          \item Outils systèmes (Python / Bash) et Web UI. (Python - Django)
