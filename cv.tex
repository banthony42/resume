...
\begin{cvSidebar}
  ...
  \begin{cvProjects}
    \cvProject[link=https://github.com/banthony42/rpg]{\texttt{Tribute to Dofus}}{
      \en{\enum{
          \color{white}
  ...
  \begin{cvEducation}
    \cvItem{
      ...
      \en {\enum {
          ...
          \item Creation of Tribute to Dofus, the early days of a connected RPG project:
          \begin {myitems}
          ...
          \item Client-server communicate using GRPC with 'tonic'.
          ...
          \item Game maps drawn in pixel art using Aseprite.
          \end {myitems}
        }}
      \fr{\enum{
          ...
          \item Création de Tribute to Dofus, les balbutiments d'un RPG connecté:
          \begin {myitems}
