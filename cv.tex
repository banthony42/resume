...
\newcommand{\DocumentVersion}{
  \begin{center}
    \color{cvGreen}
    \href{https://github.com/banthony42/resume}{Version 0.0.1 \en{10-27-2025}\fr{27/10/2025}\\{\faExternalLink*} powered by LaTeX}
  \end{center}
}
  ...
  \begin{cvExperience}
    \cvItem{
      ...
      \fr{\enum{
          ...
          \item \textnormal{\textit{Backend}}: C, Lua, Python, Django, Bash\\
          \begin {myitems}
          \item Client API REST asynchrone configurable - Historisation des paquets - CLI pour Elasticsearch - OpenIDConnect.
          \end {myitems}
          \item \textnormal{\textit{Frontend}}: CSS, JS, Kibana\\
          \begin {myitems}
          \item Dashboard Kibana (création et intégration).
          \end {myitems}
          \item \textnormal{\textit{Base de données}}: Redis, Elasticsearch
          \begin {myitems}
          \item Migration automatique des données Elasticsearch.
          \end {myitems}
...
\begin{cvMainContent}
  ...
  \begin{cvEducation}
    ...
    \cvItem{
      ...
      \fr {
        \enum{
          \item Revue de code - Pratique intensive du C : malloc, \\ nm, otool, trojan, client-serveur ftp, Wolfenstein3D.
