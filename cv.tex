...
\begin{cvMainContent}
  ...
  \begin{cvExperience}
    ...
    \cvItem{
      \en{SDK / API software developer for a robot. C\# - Unity}
      \fr{Développeur logiciel SDK / API pour robot. C\# - Unity}
      \\
  ...
  \begin{cvSkills}
    ...
    \cvSkillTwo{2}{C\#}{2}{C++}
    \cvSkillOne{2}{Rust - \en{\textbf{Active learning}}\fr{\textbf{Apprentissage actif}}}
  \end{cvSkills}
...
\begin{cvMainContent}
  ...
  \begin{cvEducation}
    \cvItem{
      ...
      \en{Learning through projects implementation, peer code review, and reading documentations. Intensive C practice then object-oriented programming with C++ and C\#. Some projects:\\C: malloc, nm , otool, client-server ftp, basic Wolfenstein 3D game\\C++: Dynamic graphic library switch at runtime around snake game\\C\#: XV (Industrial tasks viewer / editor)}
      \fr{Apprentissage du développement informatique par réalisation de projets, revue de code par les pairs et lecture de documentations. Pratique du C intensive puis de la programmation orientée objet avec le C++ et le C\#. Quelque projets réalisé:\\C: malloc, nm, otool, client-serveur ftp, Wolfenstein 3D basique\\C++: Chargement de lib dynamique au runtime autour d'un snake\\C\#: XV (Visualisation et création de tâches industriels)}}
    \cvItem{
