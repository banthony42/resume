...
\begin{cvSidebar}
  ...
  \begin{cvLanguages}
    ...
    \cvLanguage{\en{English (B1)}\fr{Anglais (B1)}}{3.5}
  \end{cvLanguages}
  \begin{cvProjects}
  ...
  \begin{cvExperience}
    \cvItem{
      ...
      \fr{\enum{
          ...
          \item Traitement du traffic en temps reel. (C / Lua)
          ...
          \item Prototypage d'une plateforme de suivi client (Rust - actix - sqlx - serde - tokio - askama - Terraform)
        }}
    }
    \cvItem{
      \color{mainFontColor}
...
%       \en {\enum {
%           \item Rust Book
%           \item \ZeroToProductionRust
%           \item \RustForRustaceans
%           \item Creation of \MainLinkColor{\href{https://github.com/banthony42/rpg}{Rusted Adventures}}, a multiplayer RPG project:
%           \begin {myitems}
%           \item gRPC (tonic) - PostgreSQL using an ORM (diesel) - Asynchronous tasks (tokyo) - Admin CLI tool (clap) - JSON assets import (serde).
%           \item Pixel art using (\MainLinkColor{\href{https://www.aseprite.org/}{Aseprite})}.
...
%       \fr {
%         \enum{
%           \item Revue de code - Pratique intensive du C
%           \item Nibbler, un jeu snake avec differentes interfaces graphiques. Chargement de bibliothèques dynamiques au runtime (C++).
%           \item \MainLinkColor{\href{https://github.com/banthony42/xv}{XV}}, 3D temps réel (C\# - Unity).
%         }
%       }
%     }
