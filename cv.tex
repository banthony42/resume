  ...
  \begin{cvExperience}
    \cvItem{
      ...
      \fr{\enum{
          ...
          \item Développement, maintenance, résolutions de la dette technique et test sur toutes les couches du logiciel.
          \item \textnormal{\textit{Backend}}: C, Lua, Python, Django, Bash\\
          \begin {myitems}
  ...
  \begin{cvEducation}
    \cvItem{
      ...
      \en {\enum {
          ...
          \item Creation of \MainLinkColor{\href{https://github.com/banthony42/rpg}{Tribute to Dofus}}, a multiplayer RPG project:
          \begin {myitems}
      ...
      \fr{\enum{
          ...
          \item Mise en pratique avec des excercices basique, import de données au format JSON, implementation d'un chat basique (client-serveur).
          \item Création de \MainLinkColor{\href{https://github.com/banthony42/rpg}{Tribute to Dofus}}, un RPG multijoueur:
          \begin {myitems}
